...
describe("Rating", () => {
    ...
    test("getQualityFactor() 1から5の範囲で正しく変換できる", () => {
        expect(new Rating(1).getQualityFactor()).toBeCloseTo(0.0);
        expect(new Rating(3).getQualityFactor()).toBeCloseTo(0.5);
        expect(new Rating(5).getQualityFactor()).toBeCloseTo(1.0);
    });
